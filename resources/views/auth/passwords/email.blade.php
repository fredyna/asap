                ...
                <div class="card px-4 py-2 box-shadow-2 width-400">
                    ...
                    <div class="card-body">
                        <div class="card-block">
                            <h6 class="text-uppercase text-bold-400 grey darken-1 text-center">Reset Password</h6>
                            <form method="POST" action="{{ route('login') }}">
                                ...
                                <div class="form-group">
                                    <div class="text-center col-md-12">
                                        <button type="submit" class="btn btn-info px-4 py-2 text-uppercase white font-small-2 box-shadow-2 border-0">Send Password Reset Link</button>
                                    </div>
                                </div>
                            </form>
                        </div>
