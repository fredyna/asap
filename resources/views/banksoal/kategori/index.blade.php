                        ...
                        <div class="row">
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <div class="card-title-wrap bar-info">
                                            <h4 class="card-title">Tambah Kategori Soal</h4>
                                        </div>
                                    </div>

                                    <div class="card-body">
                                        <div class="card-block">
                                            <form class="form" method="POST" action="{{ route('kategori-soal.store') }}">
                                                @csrf
                            ...
                            <div class="col-sm-7">
                                <div class="card">
                                    <div class="card-header">
                                        <div class="card-title-wrap bar-info">
                                            <h4 class="card-title">Data Kategori Soal</h4>
                                        </div>
                                    </div>
                                                ...
                                                <tbody>
                                                    ...
                                                    @if (!empty($kategories))
                                                        @foreach ($kategories as $kategori)
                                                            <tr>
                                                                <td>{{ $no++ }}</td>
                                                                <td style="text-align: left">{{ $kategori->kategori }}</td>
                                                                <td style="text-align: left">{{ $kategori->deskripsi ? $kategori->deskripsi:'-' }}</td>
                                                                <td>
                                                                    <a href="{{ route('kategori-soal.show', $kategori->id) }}" class="success p-0">
                                                                    ...
                                                                    <form method="POST" id="deleteTipe{{ $kategori->id }}" action="{{ route('kategori-soal.destroy', $kategori->id) }}" style="display:none;">
                                                                        @csrf
                                                                        @method('DELETE')
                                                                    </form>
                                                                </td>
