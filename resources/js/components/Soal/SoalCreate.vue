                      ...
                      <div class="px-3">
                        <div class="form-body">
                          <div class="form-group">
                            <label>Tipe</label>
                            <select class="form-control" v-model="soal.tipe_id" required>
                              <option
                                v-for="tipe in tipes"
                                :key="tipe.id"
                                :value="tipe.id"
...
export default {
  ...
  computed: {
    checkFile() {
      if (this.soal.tipe_id == 2 || this.soal.tipe_id == 3) {
        return true;
      }
      return false;
    }
  ...
  methods: {
    ...
    async handleSubmit() {
      this.errors = [];
      if (!this.soal.tipe_id) this.errors.push("Tipe soal belum dipilih");
      if (!this.soal.kategori_id)
      ...
      if (length_errors > 0) {
        ...
        postData.append("tipe_id", this.soal.tipe_id);
        postData.append("kategori_id", this.soal.kategori_id);
