                                            ...
                                            <form class="form" method="POST" action="{{ route('ujian.store') }}">
                                                ...
                                                <div class="form-body">
                                                    ...
                                                    <div class="form-group {{ $errors->has('kategori') ? 'has-error':'' }}">
                                                        ...
                                                        <select name="kategori" class="form-control" required>
                                                            ...
                                                            @foreach ($kategories as $kategori)
                                                                <option value="{{ $kategori->id }}" {{ $ujian->kategori_ujian_id == $kategori->id ? 'selected':'' }}>{{ $kategori->nama }}</option>
                                                            @endforeach
                                                        </select>
                                                    ...
                                                    <div class="form-group {{ $errors->has('nama') ? 'has-error':'' }}">
                                                        <label>Nama</label>
                                                        <input type="text" class="form-control" name="nama" value="{{ $ujian->nama }}" required>
